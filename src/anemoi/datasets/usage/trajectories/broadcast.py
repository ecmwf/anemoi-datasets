...
class GriddedAsTrajectory(Forwards):
    ...
    def collect_read_parts(self, n: FullIndex) -> None:
        # This view remaps the date axis and inserts a step axis, so the
        # rectangular two-step read cannot express it -> eager.
        return None
